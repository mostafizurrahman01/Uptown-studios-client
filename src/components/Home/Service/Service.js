    ...
    return (
        <section>
             <div className="service-container" >
                <h5 className="text-center text-primary mb-5 mt-5">Our Latest Services</h5>
            </div>
            <div className="card-group">
                {
                   serviceInfo.map(information => <ServiceDetails information={information} date={date} key={information.id}></ServiceDetails>)
                }
            </div>
        </section>
    );
